    ...
    !function () {
        ...
        qq.basePublicApi = {
            addBlobs: function (e, t, n) {
                ...
                })) : s.failure({container: t, error: "Missing image generator module"}), s
                ...
                return n || (t = this._uploadData.retrieve({id: e}), t && (n = t.file)), n || null
                ...
                if (!this.getUploads({id: e}))throw new qq.Error(e + " is not a valid file ID.");
                switch (t) {
            ...
            _addCannedFile: function (e) {
                ...
                var n, i = this, o = e.accept || this._options.validation.acceptFiles, r = e.allowedExtensions || this._options.validation.allowedExtensions;
                ...
                var n = this, i = {}, o = {
                    ...
                    isInProgress: function (e) {
                        return n.getUploads({id: e}).status === qq.status.UPLOADING
                    },
                ...
                var a = this._uploadData.addFile({uuid: n, name: t, size: i, batchId: r, file: e});
                ...
                qq.Session && null != this._options.session.endpoint && (this._session || (qq.extend(t, {cors: this._options.cors}), t.log = qq.bind(this.log, this), t.addFileRecord = qq.bind(this._addCannedFile, this), this._session = new qq.Session(t)), setTimeout(function () {
                ...
                t = this.getUploads({status: qq.status.SUBMITTING}).length, t && (qq.log("Still waiting for " + t + " files to clear submit queue. Will re-parse stored IDs array shortly."), setTimeout(function () {
        ...
        qq.FineUploaderBasic = function (e) {
            ...
            this._options = {
                ...
                chunking: {
                    ...
                    success: {
                        endpoint: null, headers: function (e) {
                            return null
                        }, jsonPayload: !1, method: "POST", params: function (e) {
                            return null
                        }, resetOnStatus: []
                    }
                },
                resume: {
                    enabled: !1, recordsExpireIn: 7, paramNames: {resuming: "qqresume"}, customKeys: function (e) {
                        return []
                    }
                },
        ...
        function a(e) {
            var t, n = qq.indexOf(b, e), i = S.maxConnections;
            delete y[e], b.splice(n, 1), b.length >= i && n < i && (t = b[i - 1], l(t))
        }

        function s(e, t) {
            var n = r(e), o = S.method, s = t === !0;
        ...
        function u(e) {
            var t, n = y[e].additionalParams, i = S.mandatedParams;
        ...
        function l(e, t) {
            var n, o = r(e, t), a = S.method, s = u(e), l = y[e].payload;
        ...
        function c(e, t, n) {
            var i = S.endpointStore.get(e), o = y[e].addToPath;
        ...
        function f(e) {
            var o = r(e), a = S.customHeaders, s = y[e].additionalHeaders || {}, u = S.method, l = {};
        ...
        var n, i, o, r = this, a = !1, s = !1, u = {
            ...
            isInProgress: function (e) {
                ...
                var t = u.getSize(e), n = u.getName(e), r = l.nextPart(e), a = o._getChunkData(e, r), d = o._getFileState(e), h = d.attemptingResume, q = d.chunking.inProgress || [];
                if (null == d.loaded && (d.loaded = 0), h && u.onResume(e, n, a, d.customResumeData) === !1 && (l.reset(e), r = l.nextPart(e), a = o._getChunkData(e, r), h = !1), null == r && 0 === q.length)l.finalize(e); else {
                    ...
                    u.onUploadChunk(e, n, o._getChunkDataForCallback(a)).then(function (n) {
                        if (u.isInProgress(e)) {
                            ...
                            var s = {chunkIdx: r, id: e, overrides: n, resuming: h};
        ...
        var r = e.options, a = this, s = e.proxy, u = qq.getUniqueId(), l = {}, c = {}, d = {}, p = r.isCors, h = r.inputName, q = s.getUuid, f = s.log, m = new qq.WindowReceiveMessage({log: f});
                ...
                p ? o(e, t) : c[e.id] = qq(e).attach("load", function () {
                    if (f("Received response for " + e.id), e.parentNode) {
                        try {
                            ...
                            f("Error when attempting to access iframe during handling of upload response (" + e.message + ")", "error"), n = {success: !1}
                        }
                        t(n)
                    }
                })
        ...
        var n = this, i = e.options.namespace, o = e.proxy, r = e.options.chunking, a = function (e) {
            var t = n._getFileState(e);
            if (t.chunkSize)return t.chunkSize;
            var i = r.partSize;
            return qq.isFunction(i) && (i = i(e, d(e))), t.chunkSize = i, i
        }, s = e.options.resume, u = r && e.options.chunking.enabled && qq.supportedFeatures.chunking, l = s && e.options.resume.enabled && u && qq.supportedFeatures.resume, c = o.getName, d = o.getSize, p = o.getUuid, h = o.getEndpoint, q = o.getDataByUuid, f = o.onUuidChanged, m = o.onProgress, g = o.log, _ = o.getCustomResumeData;
        qq.extend(this, new qq.UploadHandler(e)), qq.override(this, function (e) {
            return {
                add: function (t, i) {
                    if (qq.isFile(i) || qq.isBlob(i))e.add(t, {file: i}); else {
            ...
            clearCachedChunk: function (e, t) {
                ...
                var o = n._getFileState(e) || {}, r = o.chunking || {}, a = t || r.inProgress, s = i || r.remaining;
                ...
                var i = a(e), o = d(e), r = n.getFile(e), s = i * t, u = s + i >= o ? o : s + i, l = n._getTotalChunks(e), c = this._getFileState(e).temp.cachedChunks, p = c[t] || qq.sliceBlob(r, s, u);
                return c[t] = p, {part: t, start: s, end: u, count: l, blob: p, size: u - s}
                ...
                var t = c(e), n = d(e), o = a(e), r = h(e), u = s.customKeys(e), l = qq.format("qq{}resume{}-{}-{}-{}-{}", i, "5.0", t, n, o, r);
                ...
                var o = n._getXhr(e, t), r = c(e), a = {
                    simple: function (t, n) {
                        var i = d(e);
                        t === n ? m(e, r, i, i) : m(e, r, t >= i ? i - 1 : t, i)
                    }, chunked: function (o, a) {
                        var s = n._getFileState(e).temp.chunkProgress, u = n._getFileState(e).loaded, l = o, c = a, p = d(e), h = l - (c - i), q = u;
        ...
        function t(e, t, n) {
            var i, o, r, a, s = document.createElement("canvas"), u = 0, l = n, c = n;
        ...
        function n(e, t, n, i) {
            var r = document.createElement("canvas"), a = n.mime || "image/jpeg", s = new qq.Promise;
        ...
        function o(n, o, s, u, l) {
            var c, d = n.naturalWidth, p = n.naturalHeight, h = u.width, q = u.height, f = s.getContext("2d"), m = new qq.Promise;
            return f.save(), u.resize ? r({
                ...
                e(n) && (d /= 2, p /= 2);
                var i, o, r, a = 1024, s = document.createElement("canvas"), u = l ? t(n, d, p) : 1, c = Math.ceil(a * h / d), m = Math.ceil(a * q / p / u), g = 0, _ = 0;
        ...
        function r(e) {
            var t = e.blob, n = e.image, i = e.imageHeight, o = e.imageWidth, r = e.orientation, s = new qq.Promise, u = e.resize, l = document.createElement("canvas"), c = l.getContext("2d"), d = e.canvas, p = e.targetHeight, h = e.targetWidth;
        ...
        s.prototype.render = function (e, t) {
            t = t || {};
            var i, r = this, a = this.srcImage.naturalWidth, s = this.srcImage.naturalHeight, u = t.width, l = t.height, c = t.maxWidth, d = t.maxHeight, p = !this.blob || "image/jpeg" === this.blob.type, h = e.tagName.toLowerCase();
        ...
        function r(e) {
            var t = e.split("/"), n = t[t.length - 1].split("?")[0], i = qq.getExtension(n);
        ...
        function c(t, n, i) {
            var o = new qq.Promise, r = new qq.Identify(t, e), a = i.maxSize, s = null == i.orient || i.orient, u = function () {
            ...
            return r.isPreviewable().then(function (r) {
                ...
                }, d = s ? new qq.Exif(t, e) : c, p = new qq.MegaPixImage(t, u);
                l(n, o) && d.parse().then(function (e) {
                    var t = e && e.Orientation;
                    p.render(n, {maxWidth: a, maxHeight: a, orientation: t, mime: r, resize: i.customResizeFunction})
                }, function (t) {
        ...
        function d(e, t, n, i, o) {
            ...
            l(s, u), a(e) && (s.crossOrigin = "anonymous"), s.src = e, u.then(function () {
                l(t, n), new qq.MegaPixImage(s).render(t, {maxWidth: i, maxHeight: i, mime: r(e), resize: o})
            }, n.failure)
        }

        function p(e, t, n, i) {
            l(t, n), qq(t).css({maxWidth: i + "px", maxHeight: i + "px"}), t.src = e
        }

        function h(e, r, s) {
            var u = new qq.Promise, c = s.scale, h = c ? s.maxSize : null;
        ...
        function l(e, t) {
            ...
            return qq.each(t, function (t, r) {
                var a, s, u, l = r.slice(0, 4), c = e ? n(l) : parseInt(l, 16), p = i.indexOf(c);
        ...
        qq.extend(i, e, !0), this.refresh = function () {
            ...
            return new qq.SessionAjaxRequester(qq.extend(o, {onComplete: t})).queryServer(), e
        }
        ...
        "use strict";
        var n = e.customResizer, i = e.sendOriginal, o = e.orient, r = e.defaultType, a = e.defaultQuality / 100, s = e.failureText, u = e.includeExif, l = this._getSortedSizes(e.sizes);
        qq.extend(this, {
            enabled: qq.supportedFeatures.scaling && l.length > 0, getFileRecords: function (e, c, d) {
                var p = this, h = [], q = d.blob ? d.blob : d;
                return new qq.Identify(q, t).isPreviewableSync() ? (qq.each(l, function (e, i) {
                    var l = p._determineOutputType({defaultType: r, requestedType: i.type, refType: q.type});
                    h.push({
                        uuid: qq.getUniqueId(),
                        name: p._getName(c, {name: i.name, type: l, refType: q.type}),
                ...
                }), h.push({uuid: e, name: c, size: q.size, blob: i ? q : null})) : h.push({
                    uuid: e,
                    name: c,
                    size: q.size,
                    blob: q
                ...
                var u = this, l = (e.qqButtonId || e.blob && e.blob.qqButtonId, []), c = null, d = s.addFileToHandler, p = s.uploadData, h = s.paramsStore, q = qq.getUniqueId();
                qq.each(u.getFileRecords(n, t, e), function (e, t) {
                    ...
                    var n = {qqparentuuid: p.retrieve({id: c}).uuid, qqparentsize: p.retrieve({id: c}).size};
        ...
        scaleImage: function (e, t, n) {
            ...
            var i = new qq.Promise, o = n.log, r = n.getFile(e), a = n.uploadData.retrieve({id: e}), s = a && a.name, u = a && a.uuid, l = {
            ...
            "use strict";
            var n = this, i = e.customResizeFunction, o = e.log, r = e.maxSize, a = e.orient, s = e.type, u = e.quality, l = e.failedText, c = e.includeExif && "image/jpeg" === t.type && "image/jpeg" === s, d = new qq.Promise, p = new qq.ImageGenerator(o), h = document.createElement("canvas");
            return o("Attempting to generate scaled version for " + t.name), p.generate(t, h, {
                maxSize: r,
                orient: a,
                customResizeFunction: i
            }).then(function () {
                var e = h.toDataURL(s, u), i = function () {
        ...
        return e.KEY_STR = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", e.encode64 = function (e) {
            ...
            for (var t = 0, n = []; ;) {
                ...
                if (255 == e[t] & 216 == e[t + 1])t += 2; else {
                    var i = 256 * e[t + 2] + e[t + 3], o = t + i + 2, r = e.slice(t, o);
                    n.push(r), t = o
                }
                if (t > e.length)break
            }
        ...
        function n(e, t) {
            ...
            try {
                ...
                s("Error when attempting to parse form upload response (" + e.message + ")", "error"), n = {success: !1}
            }
            return n
        }
        ...
        "use strict";
        var n = this, i = t.getName, o = t.getSize, r = t.getUuid, a = t.log, s = e.forceMultipart || e.paramsInBody, u = function (t, n, r) {
            var a = o(t), u = i(t);
            ...
            var n, a = t.fileOrBlob, u = t.id, l = t.xhr, c = t.xhrOverrides || {}, d = t.customParams || {}, p = t.params || {}, h = c.params || {}, q = s ? new FormData : null, f = c.method || e.method, m = c.endpoint || e.endpointStore.get(u), g = i(u), _ = o(u);
            ...
            var i = t.headerOverrides, o = t.id, r = t.xhr;
            if (i)qq.each(i, function (e, t) {
                r.setRequestHeader(e, t)
            }); else {
                var a = e.customHeaders.get(o), u = n.getFile(o);
        ...
        qq.extend(this, {
            uploadChunk: function (t) {
                var i, o, r, a = t.id, s = t.chunkIdx, l = t.overrides || {}, d = t.resuming, p = n._getChunkData(a, s), h = n._createXhr(a, s), q = {};
                return i = c(a, h), n._registerProgressHandler(a, s, p.size), r = e.paramsStore.get(a), u(a, q, p), d && (q[e.resume.paramNames.resuming] = !0), o = m({
                    ...
                    xhr: h,
                    xhrOverrides: l
                }), g({headerOverrides: l.headers, id: a, xhr: h}), h.send(o), i
        ...
        function i(e) {
            var t = e.name, n = e.fullPath, i = n.lastIndexOf(t);
            return n = n.substr(0, i), "/" === n.charAt(0) && (n = n.substr(1)), n
        }

        function o(e, t, n, i) {
            var r = i || new qq.Promise, a = t || e.createReader();
        ...
        function a(e) {
            var n = new qq.UploadDropZone({
                HIDE_ZONES_EVENT_NAME: "qq-hidezones", element: e, onEnter: function (t) {
        ...
        function l() {
            var e = c.dropZoneElements, t = function () {
                setTimeout(function () {
            ...
            qq.each(e, function (t, n) {
                ...
                e.length && qq.supportedFeatures.fileDrop && h.attach(document, "dragenter", function (t) {
                    !i.dropDisabled() && s(t) && qq.each(e, function (e, t) {
                        t instanceof HTMLElement && qq(t).hasAttribute("qq-hide-dropzone") && qq(t).css({display: "block"})
                    })
                })
        ...
        var c, d = [], p = [], h = new qq.DisposeSupport;
        c = {
            dropZoneElements: [],
        ...
        qq.uiPublicApi = {
            ...
            _getButton: function (e) {
                ...
                n && n.qqPath && this._options.dragAndDrop.reportDirectoryPaths && this._paramsStore.addReadOnly(e, {qqpath: n.qqPath}), this._parent.prototype._onSubmit.apply(this, arguments), this._addToList(e, t)
            }, _onSubmitted: function (e) {
                ...
                function o(t) {
                    s && (a.setStatusText(e), qq(s).removeClass(u._classes.retrying), a.hideProgress(e), u.getUploads({id: e}).status !== qq.status.UPLOAD_FAILED && a.hideCancel(e), a.hideSpinner(e), t.success ? u._markFileAsSuccessful(e) : (qq(s).addClass(u._classes.fail), a.showCancel(e), a.isRetryPossible() && !u._preventRetries[e] && (qq(s).addClass(u._classes.retryable), a.showRetry(e)), u._controlFailureTextDisplay(e, t)))
                }

                var r = this._parent.prototype._onComplete.apply(this, arguments), a = this._templating, s = a.getFileContainer(e), u = this;
                ...
                var i, o = this.getName(e), r = this._options.deleteFile.confirmMessage.replace(/\{filename\}/g, o), a = (this.getUuid(e), arguments), s = this;
                ...
                this.getUploads({id: e}).status === qq.status.DELETED || !t && !this._options.thumbnails.placeholders.waitUntilResponse && qq.supportedFeatures.imagePreviews || this._templating.updateThumbnail(e, t, this._options.thumbnails.customResizer)
            }, _addCannedFile: function (e) {
        ...
        var t, n, i, o, r, a, s, u, l = {
        ...
        }, g = {}, _ = new qq.Promise, v = new qq.Promise, b = function () {
            ...
            var n = g[e] || (new qq.Promise).failure(), i = new qq.Promise;
            ...
            if (o = qq.trimStr(o), a = document.createElement("div"), a.appendChild(qq.toElement(o)), _ = qq(a).getFirstByClass(m.uploader), f.button && (c = qq(a).getFirstByClass(m.button), c && qq(c).remove()), qq.DragAndDrop && qq.supportedFeatures.fileDrop || (h = qq(a).getFirstByClass(m.dropProcessing), h && qq(h).remove()), d = qq(a).getFirstByClass(m.drop), d && !qq.DragAndDrop && (t("DnD module unavailable.", "info"), qq(d).remove()), qq.supportedFeatures.fileDrop ? qq(_).hasAttribute("qq-drop-area-text") && d && (g = qq(d).getFirstByClass(m.dropText), g && qq(g).remove()) : (_.removeAttribute("qq-drop-area-text"), d && qq(d).hasAttribute("qq-hide-dropzone") && qq(d).css({display: "none"})), p = qq(a).getFirstByClass(m.thumbnail), s ? p && (q = parseInt(p.getAttribute("qq-max-size")), q = q > 0 ? q : null, u = qq(p).hasAttribute("qq-server-scale")) : p && qq(p).remove(), s = s && p, n = qq(a).getByClass(m.editFilenameInput).length > 0, i = qq(a).getByClass(m.retry).length > 0, r = qq(a).getFirstByClass(m.list), null == r)throw new Error("Could not find the file list container in the template!");
            ...
            var t = e.id, n = e.optFileOrBlob, i = n && n.qqThumbnailId, o = O(t), r = {
            ...
            var t = e.id, n = e.thumbnailUrl, i = e.showWaitingImg, o = O(t), r = {
                customResizeFunction: e.customResizeFunction,
                scale: u,
                maxSize: q
            };
            ...
            var n = R(e), i = null == e ? m.totalProgressBar : m.progressBar;
            n && !qq(n).hasClass(i) && (n = qq(n).getFirstByClass(i)), n && (qq(n).css({width: t + "%"}), n.setAttribute("aria-valuenow", t))
        }, W = function (e) {
        ...
        qq.extend(f, e), t = f.log, qq.supportedFeatures.imagePreviews || (f.limits.timeBetweenThumbs = 0, f.limits.maxThumbs = 0), r = f.containerEl, s = void 0 !== f.imageGenerator, o = M(), b(), qq.extend(this, {
            render: function () {
                ...
                var u, d = o.fileTemplate.cloneNode(!0), p = N(d, m.file), h = N(r, m.uploader), q = s ? l.content : a;
                ...
                this.isHiddenForever(e) || (h.push({id: e, customResizeFunction: n, optFileOrBlob: t}), !p && w())
                ...
                var i = C(e), o = N(i, m.dialogMessage), r = i.getElementsByTagName("INPUT")[0], a = N(i, m.dialogCancelButton), s = N(i, m.dialogOkButton), u = new qq.Promise, l = function () {
        ...
        "use strict";
        function n(e) {
            var t = s.onGetName(e), n = t.lastIndexOf(".");
